    ...
    <div class="px-4 sm:px-6 lg:px-8">
        ...
        <div x-data="productSearch()" class="mt-6 max-w-2xl mx-auto relative z-10">
                            ...
                            <div class="flex items-center justify-between">
                                <div>
                                    ...
                                    <div class="text-sm text-gray-700 mt-1">
                                        ...
                                        <span x-show="!product.in_stock" class="inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium bg-pink-100 text-pink-800">Out of Stock</span>
                                    </div>
                                </div>
            ...
            <div class="mt-4 text-center text-xs text-gray-400">
                <p class="font-medium text-gray-500 mb-1">Search Tips</p>
                <p>Search by part number (e.g. <span class="font-mono text-gray-500">1234</span>, <span class="font-mono text-gray-500">FW1234</span>) or by vehicle make and model</p>
            </div>
        </div>
    </div>
